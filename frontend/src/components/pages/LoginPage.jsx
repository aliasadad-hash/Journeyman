    ...
    <div className="min-h-screen bg-[var(--background)] flex flex-col items-center justify-center p-6" data-testid="login-page">
      <div className="w-full max-w-md animate-scale-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          {error && (
            <div className="glass-gold text-[var(--brand-gold)] px-4 py-3 rounded-lg text-sm animate-scale-in" data-testid="login-error">
              {error}
            </div>
          )}
          <input 
          ...
          />
          <button type="submit" className="btn-primary w-full py-4 text-lg" disabled={loading} data-testid="login-submit-btn">
