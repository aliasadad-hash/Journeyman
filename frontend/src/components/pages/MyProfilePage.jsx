      ...
      <main className="p-4">
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex gap-3 mt-6">
            <button onClick={handleBoost} className="btn-secondary px-6 py-2 flex items-center gap-2">
              <Icons.Zap size={18} /> Boost
            </button>
            <button onClick={() => setEditing(true)} className="btn-primary px-6 py-2" data-testid="edit-profile-btn">
              Edit Profile
            </button>
          </div>
        </div>
